...
import { createComment, fetchComments, deleteComment, updateComment } from '../../api/commentApi';
...
function PostComments({ postId }) {
    ...
    return (
        <Box sx={{ mb: 4 }}>
            <Typography variant='h6' sx={{ fontWeight: 600, mb: 1, fontSize: 15 }}>댓글</Typography>
